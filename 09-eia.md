...
![Cartoon showing strollers, suitcases, bicycles, carts, and wheelchairs using curb cuts](fig/sketchplanations-the-curb-cut-effect.png){alt='Cartoon showing strollers, suitcases, bicycles, carts, and wheelchairs using curb cuts' width="600px" }
